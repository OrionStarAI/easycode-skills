...
当前仓库只放生产商城范围内的技能（当前 30 个）；个人、实验中、未上架和仅保存在本地的技能不放入这里。
...
21 个技能在 `SKILL.md` 中声明了上游仓库、源码路径和已审核提交号。GitHub Actions 每天北京时间 10:00 检查上游，也可以手动运行 **Sync upstream skills**。发现更新后，Action 会在独立分支创建或更新 PR，供人工审核。
